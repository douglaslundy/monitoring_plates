...
export default function ClientSearchPage() {
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Pesquisar Placas"
        description="Busque ocorrências por placa, câmera ou período"
      />
      ...
      {!result && !loading && (
        <div className="text-center py-20 text-muted-foreground">
          <Search
            className="h-14 w-14 mx-auto mb-4 opacity-15"
            aria-hidden="true"
          />
          <p className="text-base">Use os filtros acima para buscar ocorrências.</p>
          <p className="text-sm mt-1">Pesquise por placa completa ou parcial.</p>
        </div>
      )}
