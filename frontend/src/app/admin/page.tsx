...
import { Building2, Users, CreditCard, AlertTriangle, MessageCircle, Bell, BellRing } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const quickLinks = [
    ...
    { label: "Alertas", href: "/admin/alerts", icon: Bell, description: "Cadastrar placas monitoradas" },
    { label: "Alertas disparados", href: "/admin/alertas-disparados", icon: BellRing, description: "Listar os alertas enviados" },
