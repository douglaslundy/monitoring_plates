...
from app.api.routes import auth, users, clients, cameras, occurrences, plates, alerts, plans, agent, ocr_config, vehicles, ops, detector, whatsapp_settings, persons, face_config
